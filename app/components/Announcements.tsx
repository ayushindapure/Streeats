...
<div className="max-w-[85rem]  mx-auto">
  <div className="bg-orange-600 bg-[url('https://preline.co/assets/svg/examples/abstract-1.svg')] bg-no-repeat bg-cover bg-center p-4 text-center">
    <p className="me-2 inline-block text-white">
      The website is still in its development phase.
    </p>
