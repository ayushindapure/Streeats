...
const page = async () => {
  ...
  return (
    ...
    <div className="mt-5 max-w-3xl text-center mx-auto">
      <p className="text-lg pb-4 text-gray-600 dark:text-neutral-400">Think your favourite street food is underrated? <span className='text-black'> Prove it! </span> like the below cool peopel </p>
